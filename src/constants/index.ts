import { ChainId, JSBI, Percent, Token, WETH } from 'spaceswap-sdk-zksync'
import { AbstractConnector } from '@web3-react/abstract-connector'
import { DeploymentInfo } from 'spaceswap-sdk-zksync'
...
export const AMPL = new Token(ChainId.MAINNET, '0xD46bA6D942050d489DBd938a2C909A5d5039A161', 9, 'AMPL', 'Ampleforth')
 ...
 export const zkSPACE = new Token(ChainId.ZKSYNC, '0x47260090cE5e83454d5f05A0AbbB2C953835f777', 18, 'SPACE', 'SPACE')
...
const WETH_ONLY: ChainTokenList = {
  ...
  [ChainId.EVMOSTEST]: [WETH[ChainId.EVMOSTEST]],
  [ChainId.EVMOS]: [WETH[ChainId.EVMOS]],
  [ChainId.CELO]: [WETH[ChainId.CELO]],
  [ChainId.CELOALFAJORES]: [WETH[ChainId.CELOALFAJORES]],
...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  ...WETH_ONLY,
  [ChainId.ZKSYNC]: [...WETH_ONLY[ChainId.ZKSYNC], zkSPACE, zkUSDC]
}
