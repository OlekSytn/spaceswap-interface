...
export default function Header() {
  ...
  return (
    <HeaderFrame>
<HeaderTopTip>
        1st SPACE Buyback & Burn:
        <ExternalLink style={{ color: '#ab4df6',textDecoration: 'underline', padding: '0 3px' }} href='https://twitter.com/spacefi_io/status/1677305585459683332' target='_blank'>400,322 SPACE</ExternalLink>
        ; Bonus to Planet NFT holders Soon:
        <ExternalLink style={{ color: '#ab4df6',textDecoration: 'underline', padding: '0 3px' }} href='https://twitter.com/spacefi_io/status/1680442415784800257' target='_blank'>140,113 xSPACE</ExternalLink>
        .
      </HeaderTopTip>
