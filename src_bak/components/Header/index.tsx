...
export default function Header() {
  ...
  return (
    <HeaderFrame>
      <HeaderTopTip>
        SpaceFi released <ExternalLink style={{ color: '#ab4df6',textDecoration: 'underline', padding: '0 3px' }} href='https://twitter.com/spacefi_io/status/1674402499737042945'  target='_blank'> the New Roadmap </ExternalLink> and <ExternalLink style={{ color: '#ab4df6',textDecoration: 'underline', padding: '0 3px' }} href='https://twitter.com/spacefi_io/status/1673689479020941313'  target='_blank'> the first Buyback & Burn Plan </ExternalLink>
      </HeaderTopTip>
      <RowBetween style={{ alignItems: 'flex-start' }} padding="1rem 1rem 0 1rem">
        <HeaderElement>
          ...
          {!isMobile &&  <TitleText style={{ fontSize:'10px', color:'#FFA07A'}}>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</TitleText>}
          {!isMobile && <ExternalLink href='https://app.spacefi.io/#/bridge'  target='_blank'> Bridge</ExternalLink>}
          {!isMobile &&  <TitleText>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</TitleText>}
